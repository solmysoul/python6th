...
//
//console.log('일반 크기비교')
//console.log(nun1 > num2, num1, '>', num2);
...
//console.log(num2 == num3, num2, '==', num3;
//
//console.log('num1 > num2 && num1 > num5: ', num1 > num2 && !(num1 > num5)); //false
//console.log('num1 > num2 || num1 > num5: ', num1 > num2 || num1 > num5); //true
